...
const projects = [
  ...
  },
  {
    ...
    description: "Boutique residential development preserving historic architecture with modern interiors.",
    completion: "Completed 2023",
    units: 75,
    floors: 8,
    amenities: ["Historic Courtyard", "Library", "Garden", "Concierge", "Wine Cellar"],
...
export default function ProjectsPage() {
  ...
  const handleEnquirySubmit = (e: React.FormEvent) => {
    ...
    console.log("Enquiry submitted:", { project: selectedProject?.title, ...enquiryForm })
    // Reset form
      ...
      <section className="py-16 bg-gradient-to-br from-background to-muted/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl lg:text-6xl font-bold text-foreground">Our Projects</h1>
            <p className="text-xl text-muted-foreground max-w-3xl">
              Explore our comprehensive portfolio of residential, commercial, and mixed-use developments. Each project
              represents our commitment to quality, innovation, and community enhancement.
            </p>
          </div>
        </div>
      </section>
          ...
          <Tabs defaultValue="all" className="space-y-8">
            ...
            <TabsContent value="all" className="space-y-8">
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {projects.map((project) => (
                  <ProjectCard key={project.id} project={project} onEnquiry={setSelectedProject} />
                ))}
              </div>
            </TabsContent>
            ...
            <TabsContent value="ongoing" className="space-y-8">
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold text-foreground mb-2">Ongoing Projects</h2>
                <p className="text-muted-foreground">Currently under development</p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <TabsContent value="completed" className="space-y-8">
              <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground">Successfully delivered developments</p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <Dialog open={!!selectedProject} onOpenChange={() => setSelectedProject(null)}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Get more information about this project and schedule a consultation with our team.
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-muted/30 p-4 rounded-lg space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-muted-foreground">{selectedProject.completion}</span>
                </div>
              </div>
