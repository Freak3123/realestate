...
export function HeroCarousel() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-slate-900 text-white">
      <div className="h-[68vh] w-full" ref={emblaRef} aria-label="Featured project visuals">
        ...
        <div className="mx-auto flex h-full max-w-7xl items-center px-4 sm:px-6 lg:px-8">
          <div className="pointer-events-auto max-w-2xl">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              className="mt-3 max-w-xl text-base leading-relaxed text-slate-200 md:text-lg"
            >
              Premium residential and mixed‑use developments delivered on time with rigorous quality standards.
            </motion.p>
